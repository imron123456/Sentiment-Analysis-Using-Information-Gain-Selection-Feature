...
# Fungsi untuk mengambil ulasan dan menyimpan dalam CSV, Excel, dan JSON
def scrape_traveloka_reviews(num_reviews=100, categories=None):
    try:
        ...
        excel_file = 'traveloka_reviews.xlsx'
        reviews_df.to_excel(excel_file, index=False)
        print(f"Ulasan berhasil disimpan ke {excel_file}")
...
if __name__ == "__main__":
    ...
    num_reviews = 500  # Ubah sesuai kebutuhan
    categories = ['Username', 'Ulasan', 'Tanggal']  # Ganti None jika ingin semua kategori
